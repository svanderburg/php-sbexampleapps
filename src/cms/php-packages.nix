...
let
  packages = {
    ...
    "svanderburg/php-sbpagemanager" = {
      targetDir = "";
      src = fetchgit {
        name = "svanderburg-php-sbpagemanager-a7f9add41943d73a92c8fbc727ae4b967f0f4431";
        url = "https://github.com/svanderburg/php-sbpagemanager.git";
        rev = "a7f9add41943d73a92c8fbc727ae4b967f0f4431";
        sha256 = "1man9czncb5dj0yzbhx50l6j7qd67zvwaxhillrj6lzrizjlh9mm";
      };
    };
  };
  devPackages = {};
