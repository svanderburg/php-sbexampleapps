...
let
  packages = {
    ...
    "svanderburg/php-sbgallery" = {
      targetDir = "";
      src = fetchgit {
        name = "svanderburg-php-sbgallery-30a8a81b27c91fc399f29b99d9a9b414fdd1f3f0";
        url = "https://github.com/svanderburg/php-sbgallery.git";
        rev = "30a8a81b27c91fc399f29b99d9a9b414fdd1f3f0";
        sha256 = "1j3h7xfjwm32hk56fnb2d8c5px71vq74ij4yazsl1ndvsf2wpxjy";
      };
    };
    ...
    "svanderburg/php-sbpagemanager" = {
      targetDir = "";
      src = fetchgit {
        name = "svanderburg-php-sbpagemanager-bf0726f563b9bd2f41c8511d404001192023e192";
        url = "https://github.com/svanderburg/php-sbpagemanager.git";
        rev = "bf0726f563b9bd2f41c8511d404001192023e192";
        sha256 = "1qnaa0f1gwhhrjsgknxvb056x1g07vqrjrv9d8h9rrjp3r04ygm4";
      };
    };
  };
  devPackages = {};
